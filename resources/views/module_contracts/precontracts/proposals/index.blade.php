                   ...
                   <td>
                    ...
                    @endif
                     ...
                     @if($precontract[0]->contractId == null)  
                        ...
                        @endif  
                        @can('BCE')
                            <li><a href="{{route('proposalsSubcontractors', ['id' => $proposal->proposalId])}}"><span class="fa fa-user" aria-hidden="true"></span> Subcontratistas</a></li>          
                        @endcan
                    @endif  
                        @can('BCC')      
                          <li><a href="{{route('reports.proposal', ['id' => $proposal->proposalId])}}"><span class="fa fa-file-pdf" aria-hidden="true"></span> Imprimir</a></li>
                        @endif  
                        @if($proposal->pQuantity > 0 && $proposal)  
                          @can('BCF') 
