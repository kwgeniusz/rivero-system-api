...
<table cellspacing="0" cellpadding="1px" border="">
       <tr >
        <th style="background-color:#efcb44;font-size:18px;color:white" colspan="3" align="center"><b>TOTAL CONTRACTS BY COMPANY</b></th>
       </tr>
...
<script type="text/php">
    if ( isset($pdf) ) {
        $pdf->page_script('
            ...
            $pdf->text(210, 805, "© Copyright 2022 JD Rivero Global - All rights reserved", $font, 8);
