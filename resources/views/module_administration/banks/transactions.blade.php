...
@section('content')
<span class="logo-lg "><h3><b> TRANSACCIONES EN BANCOS</b></h3></span>
 <div class="text-center">
  <h4 class="text-success text-left">Saldo inicial año {{$year}}: <u>${{$initialBalance}}</u></h4>
<br>
 <form class="form" action="{{Route('banks.transactionsResults')}}" method="POST">
        {{ csrf_field() }}

    <select-bank-with-account pref-url='./'></select-bank-with-account>
