...
<div class="panel panel-success">
    <div class="panel-heading text-center"> <h3><b>NUEVO SERVICIO</b></h3></div>
 ...
 <form class="form form-prevent-multiple-submits" action="{{Route('services.store')}}" method="POST">
        {{csrf_field()}}
      ...
      @if($hasCost == 'Y')
         <div class="form-group col-xs-8 col-xs-offset-2 col-lg-5 col-lg-offset-2">
            ...
            <input type="number" class="form-control" id="cost1" name="cost1" value="{{ old('cost1')}}">
          </div>

          <div class="form-group col-xs-8 col-xs-offset-2 col-lg-5 col-lg-offset-2">
                <label for="cost2">PRECIO POR EA:</label>
                <input type="number" class="form-control" id="cost2" name="cost2" value="{{ old('cost2')}}">
          </div>
     @endif
