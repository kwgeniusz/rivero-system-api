...
@if($date1 != '')
  <div  align="center" >
     <h2>From: {{$date1->format('m/d/Y')}} To: {{$date2->format('m/d/Y')}}</h2>
  </div>
...
<tr style="background-color:{{$background}}; font-size:8px;">
        ...
        @if($acum2 == 1)
         <td align="center">{{$header['entryNumber'] }}</td>
         <td align="center">{{Carbon\Carbon::parse($header['entryDate'])->format('m/d/Y')}}</td>
         @else
         <td align="center"></td>
         <td align="center"></td>
         @endif
