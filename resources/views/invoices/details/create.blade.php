...
<div class="panel panel-success col-xs-7">
    <div class="panel-heading"> <h3><b>Nueva Factura</b></h3></div>
   ...
   <div class="row">
          <div class="form-group col-xs-4">
            <label for="invoiceNumberFormat">CODIGO</label>
            <input type="text" class="form-control" id="invoiceNumberFormat" name="invoiceNumberFormat" value="{{ $invoiceNumberFormat}}" disabled="on">
          </div>
 </div>
