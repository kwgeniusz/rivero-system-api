                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                           ...
                           <tbody v-if="searchData.length > 0">      
                             <tr v-for="(transaction, index) in searchData" :key="index">
                                <td >{{index + 1}}</td>
                                <td class="text-left"> {{transaction.transactionNumber}}</td>
                                <td class="text-left"> {{transaction.general_ledger.accountCode}} - {{transaction.general_ledger.accountName}}</td>
                                <td class="text-left"> {{transaction.transactionDate | moment("MM/DD/YYYY ")}}</td>  
                                <td class="text-left"> {{transaction.transactionDescription}}</td>
                                <!-- <td class="text-left"> {{transaction.transactionReference}}</td> -->
