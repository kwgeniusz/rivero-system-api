                           ...
                           <tbody v-if="searchData.length > 0">      
                             <tr v-for="(generalLedger, index) in searchData" :key="index">
                                ...
                                <td> 
                                 ...
                                 <a v-if="generalLedger.hasAuxiliary == 'Y'" :href="`general-ledgers/${generalLedger.generalLedgerId}/auxiliaries`" class="btn btn-sm btn-info" title="Auxiliares"><i class="fa fa-book"></i></a> 
