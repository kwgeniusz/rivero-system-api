<template>
    ...
    <!-- agregar -->
        <div v-if="formStatus === 1">
            <intercompany-addUp-service-equivalence
                @showlist = "showlist"
                :editId=0
            > </intercompany-addUp-service-equivalence> 
        </div>
    ...
    <!-- botones y listado -->
        <div v-if="formStatus === 0">
         ...
         <div class="panel panel-default" >
            ...
            <intercompany-table-service-equivalence  
...
<script>
    export default {
        mounted() {
            ...
            axios.get(`/intercompany/service-equivalences`,  { params: { companyToLinkId: this.companyToLinkId } }).then((response) => {
