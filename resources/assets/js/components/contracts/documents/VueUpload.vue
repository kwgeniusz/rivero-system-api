    ...
    <div class="upload1" v-show="!isOption">
                ...
                <div class="btn-group">
                  ...
                  <div class="dropdown-menu">
                    ...
                    <a
                      ...
                      @click.prevent="
                        file.active
                          ? $refs.upload1.update(file, { error: 'cancel' })
                          : false
                      "
                      >Cancelar</a
                    >
                    ...
                    <a
                      ...
                      v-if="file.active"
                      @click.prevent="
                        $refs.upload1.update(file, { active: false })
                      "
                      >Abortar</a
                    >
                    <a
                      ...
                      v-else-if="
                        file.error &&
                          ...
                          $refs.upload1.features.html5
                      "
                      @click.prevent="
                        $refs.upload1.update(file, {
                          active: true,
                          error: '',
                          progress: '0.00',
                        })
                    ...
                    <a
                      ...
                      @click.prevent="
                        file.success || file.error === 'compressing'
                          ? false
                          : $refs.upload1.update(file, { active: true })
                      "
                      >Cargar</a
                    >
      ...
      <div class="example-foorer">
        ...
        <button
          ...
          v-if="!$refs.upload1 || !$refs.upload1.active"
        ...
        <button
          ...
          v-else
          @click.prevent="$refs.upload1.active = false"
        >
...
export default {
  ...
  data: function() {
    return {
      ...
      accept: "",
      extensions:
        "gif,jpg,jpeg,png,webp,pdf,doc,docx,ppt,pptx,xls,xlsx,mp4,mov,mp3,dwg,dxf,dwf,bin,bak,HEIC,heic, heif,zip,tif,skp,dgn,dsd,ctb,pln,bpn,gsm,lcf,rar,sdb,pro,mcdx,kmz,kml,gmw,csv,txt,fbx,ls8,ls9,ls10,bimx,shx,SHX",
