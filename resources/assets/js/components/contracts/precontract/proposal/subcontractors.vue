...
<template> 
 ...
 <h4><b>Cotizacion N°:</b> {{proposal[0].propId}}</h4>
 ...
 /*------------------SEARCH METHODS-------------------- */
         findInvoice: function (){
             let url ='../../invoices/'+this.proposalId;
             axios.get(url).then(response => {
              this.invoice = response.data
             });
         },
         getAllProposalsDetails: function (){
 ...
 /*------------------FORM METHODS-------------------- */
        ...
        if (!this.errors.length) { 
           ...
           if(this.form.typeOfAgreement == 'detailed'){
             ...
             axios.post('../../subcontractors/add/invDetail',{
                 ...
                 proposalId: this.serviceSelected.proposalId,
       ...
       removeSubcontractor: function(subcontPropDetailId) {
         axios.post('../../subcontractors/remove/propDetail',{
                 subcontPropDetailId :  subcontPropDetailId,
           }).then(response => {
                    if (response.data.alertType == "error") {
                        toastr.error(response.data.message)
                    } else {
