                ...
                <table class="table table-striped table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr v-for="(hrTansType, index) in objHrTansType" :key="hrTansType.hrtransactionTypeId">
                            ...
                            <td> 
                                <button v-on:click="editRow(index, hrTansType.hrtransactionTypeId)" class="btn btn-sm btn-primary" title="Editar"><i class="fa fa-edit"></i> </button>  
                                <button v-on:click="deleterow(index, hrTansType.hrtransactionTypeId)" class="btn btn-sm btn-danger" title="Eliminar"><i class="fa fa-times-circle"></i></button>  
                            </td>
                        </tr>
                    </tbody>
                </table> 
