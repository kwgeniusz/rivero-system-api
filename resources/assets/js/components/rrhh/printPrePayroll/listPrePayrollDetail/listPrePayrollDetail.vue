            ...
            <div class="panel-heading">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-1 col-md-offset-2">
                        <button v-on:click="printDetailRow(objprePayrollDetail[11][0].countryId, objprePayrollDetail[11][0].companyId, objprePayrollDetail[11][0].year, objprePayrollDetail[11][0].payrollNumber)" class="btn btn-sm btn-info"><i class="fa fa-print"></i> </button>  
                    </div>
                </div> 
            </div>
