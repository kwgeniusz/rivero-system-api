                ...
                <table class="table table-striped table-bordered text-center">
                    ...
                    <!-- <tbody v-if="objPreVacation.length > 0">
                        <tr v-for="(preVacation, index) in objPreVacation" :key="preVacation.hrpayrollControlId">
                            ...
                            <td>
                                <button v-if="loading === false" v-on:click="process(preVacation.hrpayrollControlId)" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> Procesar</button>  
                                ...
                                <button v-on:click="deletePreVacation(index, preVacation.hrpayrollControlId)" class="btn btn-sm btn-danger"><i class="fa fa-times-circle"></i> Eliminar</button>  
                            </td>
                        </tr>
                    </tbody>
                    <tbody v-else>
