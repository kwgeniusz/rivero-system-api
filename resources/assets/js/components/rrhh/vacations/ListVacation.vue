        ...
        printVacationByEmployee(){
            ...
            axios.get(URL2).then( res => {
                ...
                axios.get(URL).then( res => {
                    ...
                    let baseSalary =  objPrePayrollDetail[14]
                    baseSalary = baseSalary.toString()
                    let employeeName =  objPrePayrollDetail[15][0].staffName
                    let employmentDate =  objPrePayrollDetail[15][0].employmentDate
                    let employeePosition =  objPrePayrollDetail[15][0].positionName
                    let employeeID =  objPrePayrollDetail[15][0].idDocument
                    let startVacation = this.formatDate2(this.startVacation)
                    let endVacation = this.formatDate2(this.endVacation);
                    let dataTimes = this.formatDate()
                    ...
                    let n = 155 // Utilizada para asignar el numero de posisionamiento del salto de linea inicial
