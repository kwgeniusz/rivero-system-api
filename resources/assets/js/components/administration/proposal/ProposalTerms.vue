  ...
  <form class="formTerms">
    ...
    <div class="form-group col-xs-10 col-xs-offset-1" v-if="inputType == 'A'">
      ...
      <select
        ...
        id="termId"
      >
        <option v-for="(item, index) in notes" :value="item.termId">
    ...
    <div class="row">
      ...
      <div class="col-xs-4 text-center">
        <a class="btn btn-warning" href="/crud-term" role="button">
          <span class="fa fa-list" aria-hidden="true"></span> Terms &
          Conditions</a
        >
      </div>
...
<script>
import formNewTerm from "./FormNewTerm.vue";
