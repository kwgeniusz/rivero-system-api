                    ...
                    <div class="table-responsive text-center">
                     ...
                     <tbody v-if="transactionTypeList.length > 0">       
                      <tr v-for="(transaction, index) in transactionTypeList" :key="index">
                                ...
                                <td> 
                                  <button @click="editTransactionType(index,transaction.transactionTypeId)" class="btn btn-sm btn-primary" title="Editar"><i class="fa fa-edit"></i></button>  
                                  <button @click="deleteTransactionType(index,transaction.transactionTypeId)" class="btn btn-sm btn-danger" title="Eliminar"><i class="fa fa-times-circle"></i></button> 
                                </td>
                         </tr>
                      </tbody>
                     </table>
