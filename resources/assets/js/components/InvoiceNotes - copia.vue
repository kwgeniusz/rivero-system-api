          ...
          <h4><b>Terminos y Condiciones</b></h4>
           <ul>
            <li v-for="note in listNotes">
              {{ note.noteName }}
              <a @click="deleteNote(note.invNoteId)" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Eliminar">
...
export default {
  ...
  /*----CRUD----- */
        add: function() {
          ...
          deleteNote: function(invNoteId) {
             let url ='invoicesNotes/'+invNoteId;
