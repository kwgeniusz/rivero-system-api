...
var _plugin = _interopRequireDefault(require("sweet-modal-vue/src/plugin.js"));

var _Permissions = _interopRequireDefault(require("./mixins/Permissions"));
...
Vue.mixin(_Permissions["default"]); // import ProgressBar from 'vue-simple-progress';

Vue.use(_vueMoment["default"], {
...
Vue.component('grid-files', require('./components/contracts/documents/GridFiles.vue')); //########### module administration components #############
...
Vue.component('btn-invoice-collection', require('./components/administration/BtnInvoiceCollection.vue')); // Vue.component('subcontractor-datasheet', require('./components/contracts/SubcontractorDatasheet.vue'));
...
Vue.component('add-Departements', require('./components/rrhh/department/addDepartements.vue')); // --> payroll type
...
Vue.component('AddUp-Payroll-Type', require('./components/rrhh/payrolltype/AddUpPayrollType.vue')); // --> position
...
Vue.component('add-position', require('./components/rrhh/position/addPosition.vue')); //--> Transactions Type
...
Vue.component('addUp-transactions-type', require('./components/rrhh/transactionstype/addUpTransactionsType.vue')); //--> periods
...
Vue.component('addUp-periods', require('./components/rrhh/periods/addUpPeriods.vue')); //--> process
...
Vue.component('addUp-process', require('./components/rrhh/process/addUpProcess.vue')); //--> --> process-Detail

Vue.component('list-process-detail', require('./components/rrhh/process/processDetail/listProcessDetail.vue'));
Vue.component('add-up-process-detail', require('./components/rrhh/process/processDetail/addUpProcessDetail.vue')); // --> Staff
...
Vue.component('add-up-staff', require('./components/rrhh/staff/addUpStaff.vue')); // --> payrollControll
...
Vue.component('add-up-payroll-control', require('./components/rrhh/payrollControl/addUpPayrollControl.vue')); // PRINT PRE-PAYROLL
...
Vue.component('list-pre-payroll-detail-staff', require('./components/rrhh/printPrePayroll/listPrePayrollDetail/listPrePayrollDetailStaff.vue')); // PRINT PAYROLL

Vue.component('main-payroll', require('./components/rrhh/print-payroll/mainPrintPayroll.vue'));
Vue.component('list-payroll', require('./components/rrhh/print-payroll/listPrintPayroll.vue')); // permanent Transaction
...
Vue.component('addUp-permanent-trans', require('./components/rrhh/permanetTransaction/addUpPertmanetTrac.vue')); // uptade payroll
...
Vue.component('add-up-payroll-history', require('./components/rrhh/update-payroll/addUpPayrollHistory.vue')); // paycheck
...
Vue.component('list-recipt-detail', require('./components/rrhh/paycheck/paycheckDetail/listReciptDetail.vue')); //########### Dashboard Counters #############
// --> Front Page
...
Vue.component('contract-chart', require('./components/srcComponent/ContractChart.vue')); //############ COMFIGURATION COMPANY COMPONENTS ##############
...
Vue.component('list-company', require('./components/configuration/company/listCompany.vue')); // ########### srcComponent 
